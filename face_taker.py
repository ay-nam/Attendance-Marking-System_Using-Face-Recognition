...
def get_face_id(directory: str) -> int:
    ...
    i.e., Generates a unique face ID by scanning existing files in the directory and finding the next available number.
...
def add_student_to_db(collection, face_id, face_name):
    """
    Add a new student to the MongoDB collection.

    Parameters:
        collection: The MongoDB collection.
        face_id (int): The identifier of the student.
        face_name (str): The name of the student.
    """
    student_data = {
        'face_id': face_id,
        'name': face_name,
    ...
    print(f'[INFO] Student {face_name} with ID {face_id} added to the database.')
...
if __name__ == '__main__':
    ...
    # Add student details to the MongoDB
    add_student_to_db(collection, face_id, face_name)
